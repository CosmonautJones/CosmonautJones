...
Portfolio-facing highlights (not a claim about live GitHub pins):
...
- Start with the user or operator workflow, not a stack checklist.
- Keep acceptance criteria and test evidence close to the implementation.
- Treat documentation, failure states, and rollback paths as part of the product.
- Use AI tooling behind explicit constraints, verification, and human review.
